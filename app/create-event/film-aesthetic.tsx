...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 28, lineHeight: 40, letterSpacing: 0.2, marginBottom: 10, paddingHorizontal: H_PAD },
  subtext: { fontSize: 14, lineHeight: 22, opacity: 0.6, marginBottom: 28, paddingHorizontal: H_PAD },
